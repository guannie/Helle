            ...
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Patient Record</h4>
                                <!-- <p class="category">for Cardiovascular Diseases</p> -->
                            </div>
                            <div class="content">

                                <br>
                                  <form style="width:50%; margin-left: auto; margin-right: auto;" method="POST" action="{{URL::route('edit_process')}}" enctype="multipart/form-data" novalidate><!--xde validation-->
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            
                                    <div class="form-group @if($errors->has('patientID"')) has-error @endif">
                                        <label for="patientID">Patient ID</label>
                                        <input type="text" class="form-control" id="patientID" name="patientID" placeholder="PatientID" value="{{$record->patientID}}" disabled> @if($errors->has('patientID')) <p class="help-block">{{ $errors->first('patientID') }}</p> @endif
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{$record->name}}"> @if($errors->has('name')) <p class="help-block">{{ $errors->first('name') }}</p> @endif
                                    </div>

                                    <div class="form-group">
                                        <label for="age">Age</label>
                                        <input type="text" class="form-control" id="age" name="age" placeholder="Age" value="{{$record->age}}"> @if($errors->has('age')) <p class="help-block">{{ $errors->first('age') }}</p> @endif
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Gender</label>
                                        <input type="text" class="form-control" id="gender" name="gender" placeholder="Gender" value="{{$record->gender}}"> @if($errors->has('gender')) <p class="help-block">{{ $errors->first('gender') }}</p> @endif
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Days in Hospital</label>
                                        <input type="text" class="form-control" id="days" name="days" placeholder="Days in Hospital" value="{{$record->daysInHospital}}"> @if($errors->has('days')) <p class="help-block">{{ $errors->first('days') }}</p> @endif
                                    </div>
                                    <br>
